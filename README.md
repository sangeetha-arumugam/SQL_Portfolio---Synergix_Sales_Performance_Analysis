...
**Insight:** There are a lot of products with zero revenue.These are those products which are not contributing to the growth of the company, but are these products experiencing any traffic or is the traffic zero for them as well?

![Alternative Text](assets/images/Findings Q3.png) 

• **Checking Traffics for Zero revenue products**   

**Insight:** In addition to zero revenue, there is zero traffic for some products. There are some products with no revenue, but positive traffic, while some with no traffic and no revenue. Also, there are some products with positive traffic and positive revenue.
